"""
    ...
    Heart_Rate_Listener grabs the message from the Heart_Rate_Queue and will alert the user if their heart rate gets above 120 bpm.
...
def main(hn: str = "localhost", qn: str = "Heart_Rate_Queue"):
...
if __name__ == "__main__":
    ...
    main("localhost", "Heart_Rate_Queue")